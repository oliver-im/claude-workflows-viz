 ...
 * notably a readability authoring pass (see `docs/readable-diagrams.md`), which
 * reads this to find code-shaped labels and thin phase details, then rewrites
 * the workflow's own authored strings into prose.
 *
 ...
 * never paraphrases or guesses — turning the structure into human prose is an
 * authoring step a human reviews, never the binary's.
 *
