 ...
 *
 * The output is a pure function of `meta` — nothing about the tool itself
 * (version, timestamp) is drawn onto the diagram, so the same input always
 * yields byte-identical SVG across tool versions.
 */
